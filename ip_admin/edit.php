                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="segment" name="segment" value="<?php echo $data['segment'];?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="switch" name="switch" value="<?php echo $data['switch'];?>">

                        </div>
                        <div class="form-group">
                            <label for="keterangan_ip">Keterangan</label>
                            <input class="form-control" type="text" name="keterangan_ip" value="<?php echo $data['keterangan_ip'];?>">
                        </div>
